...
//        CreateCouponDTO couponDTO = new CreateCouponDTO(couponName, 20.0, LocalDateTime.now().plusDays(30), 100.0, CouponType.INDIVIDUAL);
...
//        CreateCouponDTO couponDTO = new CreateCouponDTO("SummerSale", 25.0, LocalDateTime.now().plusDays(30), 200.0,  CouponType.INDIVIDUAL);
//        String requestBody = "{ \"name\": \"" + couponDTO.name() + "\", \"discount\": " + couponDTO.discount() + ", \"expirationDate\": \"" + couponDTO.expirationDate() + "\", \"minPurchaseAmount\": " + couponDTO.minPurchaseAmount() + " }";
//
//        // Perform the POST request
//        mockMvc.perform(post("/api/admin/create-coupon")
